...
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event FPUIOC"]
    #[inline(always)]
    pub fn fpuioc(&mut self) -> FpuiocW<'_, IntenclrSpec> {
        FpuiocW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event FPUDZC"]
    #[inline(always)]
    pub fn fpudzc(&mut self) -> FpudzcW<'_, IntenclrSpec> {
        FpudzcW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event FPUOFC"]
    #[inline(always)]
    pub fn fpuofc(&mut self) -> FpuofcW<'_, IntenclrSpec> {
        FpuofcW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event FPUUFC"]
    #[inline(always)]
    pub fn fpuufc(&mut self) -> FpuufcW<'_, IntenclrSpec> {
        FpuufcW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event FPUIXC"]
    #[inline(always)]
    pub fn fpuixc(&mut self) -> FpuixcW<'_, IntenclrSpec> {
        FpuixcW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event FPUIDC"]
    #[inline(always)]
    pub fn fpuidc(&mut self) -> FpuidcW<'_, IntenclrSpec> {
        FpuidcW::new(self, 5)
    }
}
